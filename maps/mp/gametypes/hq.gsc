...
/////////////// Added by AWE /////////////
	maps\mp\gametypes\_awe::spawnradios();
//////////////////////////////////////////
...
{
	if(getCvarInt("scr_hq_extrapoints") > 0)
	{
		players = getentarray("player", "classname");
		for(i = 0; i < players.size; i++)
		{
			if(isdefined(players[i].pers["team"]) && players[i].pers["team"] == team && players[i].sessionstate == "playing")
			{
				...
				{
					players[i].score += 3;
					//players[i] iprintln ("You gained 3 points for defending your teams radio");
				}
				else if (reason == "lost")
				{
					players[i].score -= 3;
					//players[i] iprintln ("You lost 3 points for losing the radio");
				}
			}
		}
	}
