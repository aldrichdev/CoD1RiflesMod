...
main()
{
	level.flagmodel["axis"]	= "xmodel/" + cvardef("scr_actf_axis_flagmodel",		"stalingrad_flag","","","string");
	level.flagmodel["allies"]="xmodel/" + cvardef("scr_actf_allied_flagmodel",	"stalingrad_flag","","","string");
	
	level.flagmodel_dropped["axis"] 	= "xmodel/" + cvardef("scr_actf_axis_flagmodel_dropped",	"stalingrad_flag","","","string");
	level.flagmodel_dropped["allies"] 	= "xmodel/" + cvardef("scr_actf_allied_flagmodel_dropped",	"stalingrad_flag","","","string");
...
/*
	//////////////////////////////////////////////////////////////////////////////////
	//Check for weapon & healthdrop flags
	//////////////////////////////////////////////////////////////////////////////////
	if(getcvarint("scr_weapondrops") > 0)
		self maps\mp\gametypes\_mcUtility::DropWeapon();
	//
	if(getcvarint("scr_healthdrops") > 0 && self.hashealth > 0)
		self dropHealth();
	//////////////////////////////////////////////////////////////////////////////////

	body = self cloneplayer();
	body setmodel (self.model);
	body.hashealth = self.hashealth;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////
	if(getcvarint("scr_bloodpools") > 0)
	{					
		if (self.decaped ==1)	
		{
			body thread maps\mp\gametypes\_mcUtility::Neck_Bleed();
			playfxontag(level._effect["bloodspurt"],body,"Bip01 Neck");
		}
	}
	...
	{					
		if (self.decaped ==1)	
			...
			playfxontag (level._effect["bloodpools_body"], body,"Bip01 Neck");
		else
		{
			playfx (level._effect["bloodpools_body"], body.origin);
			body thread maps\mp\gametypes\_mcUtility::Bleed_From_Wound(sHitLoc);		
		}
	}

	//body thread maps\mp\gametypes\_mcUtility::waitsearch();
	/////////////////////////////////////////////////////////////////////////////////////////////
...
//			objective_position(self.objnum, self.origin);
			...
			// Does my flag exist and is not currently being stolen?
			if(isdefined(level.flag[myteam]["flag"]) && !isdefined(level.flag[myteam]["flag"].stolen) )
			{
				// Am I touching it and it is not currently being stolen?
				if(self isTouchingFlag(myteam) && !isdefined(level.flag[myteam]["flag"].stolen) )
				{
//					self iprintlnbold("Touching our " + level.flagname[myteam]);
...
//				self iprintlnbold("Touching enemy " + level.flagname[otherteam]);
...
//				self.flagindicator.x = 120;
//				self.flagindicator.y = 408;
